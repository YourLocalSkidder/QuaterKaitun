...
local library = {
	WorkspaceName = "Quarterty Hub Premium Script",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
	...
	colors = {
		...
		selectedOption = Color3.fromRGB(0, 50, 72),
		unselectedOption = Color3.fromRGB(8, 52, 59),
